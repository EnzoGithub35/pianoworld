    ...
    >
      <div className="relative">
        ...
        {event.kind === 'session' ? (
          ...
          <span className="absolute -bottom-0.5 -right-0.5 flex h-3.5 w-3.5 items-center justify-center rounded-full border-2 border-background bg-amber-500 text-amber-950">
