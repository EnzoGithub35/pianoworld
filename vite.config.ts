  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // Couleurs alignées avec le branding "Bois de piano" :
        // - theme_color : ambre/orange du favicon (status bar mobile)
        // - background_color : crème PianoWorld (splash screen sans flash blanc)
        theme_color: '#c97a1e',
